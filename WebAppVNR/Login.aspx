<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebAppVNR.Login" %>
    ...
    <asp:Panel ID="panlogin" runat="server">
        <div class="main">
            ...
            <a class="submit" align="center">
                <asp:Button ID="btnlogin" runat="server" Text="Sign In" OnClick="btnlogin_Click" /></a>
            <p class="forgot" align="center">
                <a href="Register.aspx">Register</a></p>
            <p class="forgot" align="center">
              <a href="ForgetPassword.aspx">Forget Password</a></p>
        </div>
    </asp:Panel>
